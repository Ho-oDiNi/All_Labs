...
double lagr(double X, double x[_N], double y[_N]) {
...
void etk(double X, double x[_N], double y[_N])
{
	cout << "\n"; 
	for(int j = 1; j < _N; j++)
	{
...
int main()
{
	...
	while(t!=0) 
	{
		...
		cout << "2 - Lagrange\n";
		cout << "3 - Etken\n";
		cout << "4 - Integral with double conversion\n";
		cout << "5 - DU\n";
		cout << "0 - Exit\n";
		cin >> t;
		switch(t)

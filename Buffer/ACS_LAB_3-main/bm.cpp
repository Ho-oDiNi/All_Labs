...
double* test_ram_w(uint block_size, uint launch_count)
{
    ...
    for (int launch = 0; launch < launch_count; launch++)
    {
        ...
        result[launch] = (double)(end.tv_nsec - begin.tv_nsec) / NANOS_IN_SEC;
...
double* test_ssd_w(uint block_size, uint launch_count)
{
    ...
    for (int launch = 0; launch < launch_count; launch++)
    {
        ...
        if (end.tv_sec - begin.tv_sec > 0) 
            duration = (double)((end.tv_sec - begin.tv_sec) * NANOS_IN_SEC + end.tv_nsec - begin.tv_nsec) / NANOS_IN_SEC;
        else 
            duration = (double)(end.tv_nsec - begin.tv_nsec) / NANOS_IN_SEC;
